...
public class DoubleColumnStatsData implements org.apache.thrift.TBase<DoubleColumnStatsData, DoubleColumnStatsData._Fields>, java.io.Serializable, Cloneable, Comparable<DoubleColumnStatsData> {
  ...
  public double lowValue; // required
  public double highValue; // required
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'lowValue' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'highValue' because it's a primitive and you chose the non-beans generator.
  ...
  private static class DoubleColumnStatsDataStandardScheme extends StandardScheme<DoubleColumnStatsData> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, DoubleColumnStatsData struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetLowValue()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'lowValue' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetHighValue()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'highValue' was not found in serialized data! Struct: " + toString());
      }
