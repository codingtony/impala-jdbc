...
public class ShowCompactResponseElement implements org.apache.thrift.TBase<ShowCompactResponseElement, ShowCompactResponseElement._Fields>, java.io.Serializable, Cloneable, Comparable<ShowCompactResponseElement> {
  ...
  public String partitionname; // required
  /**
   * 
   * @see CompactionType
   */
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (partitionname == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'partitionname' was not present! Struct: " + toString());
    }
    if (type == null) {
    ...
    if (workerid == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'workerid' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'start' because it's a primitive and you chose the non-beans generator.
    if (runAs == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'runAs' was not present! Struct: " + toString());
    }
