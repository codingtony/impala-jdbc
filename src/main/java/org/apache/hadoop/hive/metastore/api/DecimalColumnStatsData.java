...
public class DecimalColumnStatsData implements org.apache.thrift.TBase<DecimalColumnStatsData, DecimalColumnStatsData._Fields>, java.io.Serializable, Cloneable, Comparable<DecimalColumnStatsData> {
  ...
  public Decimal lowValue; // required
  public Decimal highValue; // required
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (lowValue == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'lowValue' was not present! Struct: " + toString());
    }
    if (highValue == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'highValue' was not present! Struct: " + toString());
    }
